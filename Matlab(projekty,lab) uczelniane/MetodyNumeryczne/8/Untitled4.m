...
disp (macg);
x=zeros(n,n); % Stworzenie macierzy wektorów w³asnych korzystaj¹c z macierzy g oraz Y
for j=1:n
    for i=1:n
...
disp(x)
for j=1:n % Normalizacja wektorów w³asnych
    max=0;
    for i=1:n
...
disp ('Wyœwietlenie macierzy WW');
disp(x) % Wyœwietlenie macierzy WW zawieraj¹cej wektory znormalizowanych odpowiadaj¹ce wartoœciom w³asnym.