...
n=400; % liczba punktow siatki
b=5;  % definicja gornej granicy dziedziny rozwiazania <0,b>
...
L=ones(n,1);      % L(v)=1 - funkcja okreœlaj¹ca j¹dro
...
%K=tril(K) % funkcja zeruj¹ca, w razie potrzeby, górny prawy trójk¹t j¹dra.
disp('Rozwi¹zanie dla danych z przyk³adu: lambda=1, f(x)=1, L(x-t)=1');
